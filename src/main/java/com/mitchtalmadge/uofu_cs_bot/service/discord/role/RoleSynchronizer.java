...
/**
 * Role Synchronizers listen for and act upon Role synchronization lifecycle events. Roles must be
 * added, removed, and organized in a specific order to prevent collisions.
 */
...
public abstract class RoleSynchronizer {
  ...
  /**
   * The prefix to filter out roles for each method in the synchronizer. Only roles that begin with
   * this prefix will be given as parameters to the methods. Case Insensitive.
   */
  private final String rolePrefix;

  /**
   * Determines the order in which different synchronizers will order their roles relative to each
   * other. 0 means the roles for this synchronizer will be placed at the top.
   */
