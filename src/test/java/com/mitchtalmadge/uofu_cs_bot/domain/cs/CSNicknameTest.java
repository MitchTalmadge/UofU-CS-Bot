...
public class CSNicknameTest {
    ...
    public void TestParseStandardNickname() throws Exception {
        // One class
        Assert.assertArrayEquals(new Course[]{cs3500}, new CSNickname("John Doe [3500]").getClasses().toArray());

        // Two courses
        Assert.assertArrayEquals(new Course[]{cs3500, cs3810}, new CSNickname("John Doe [3500, 3810]").getClasses().toArray());

        // Three courses
        Assert.assertArrayEquals(new Course[]{cs2420, cs3500, cs3810}, new CSNickname("John Doe [2420, 3500, 3810]").getClasses().toArray());
    }

    /**
     * Tests nicknames with comma separated lists of courses in random order inside square brackets.
     */
    @Test
    public void TestParseRandomOrderNickname() throws Exception {
        // Two courses
        Assert.assertArrayEquals(new Course[]{cs3500, cs3810}, new CSNickname("John Doe [3810, 3500]").getClasses().toArray());

        // Three courses
        Assert.assertArrayEquals(new Course[]{cs2420, cs3500, cs3810}, new CSNickname("John Doe [3500, 2420, 3810]").getClasses().toArray());
    }
    ...
    public void TestParseWithPrefixes() throws Exception {
        // One class
        Assert.assertArrayEquals(new Course[]{cs3500}, new CSNickname("John Doe [cs-3500]").getClasses().toArray());

        // Two courses
        Assert.assertArrayEquals(new Course[]{cs3500, cs3810}, new CSNickname("John Doe [CS 3500, 3810]").getClasses().toArray());

        // Three courses
        Assert.assertArrayEquals(new Course[]{cs2420, cs3500, cs3810}, new CSNickname("John Doe [2420, Cs-3500, cs3810]").getClasses().toArray());
    }
    ...
    public void TestParseWithSuffixes() throws Exception {
        ...
        Assert.assertArrayEquals(new Course[]{cs2420, cs3500, cs3810}, threeClasses.getClasses().toArray());
    ...
    public void TestMultipleBracketsInNickname() throws Exception {
        // One class
        Assert.assertArrayEquals(new Course[]{cs3500}, new CSNickname("John Doe [3500] [USD]").getClasses().toArray());

        // Two courses
        Assert.assertArrayEquals(new Course[]{cs3500, cs3810}, new CSNickname("[Super Cool Clan] John Doe [3500, 3810]").getClasses().toArray());

        // Three courses
        Assert.assertArrayEquals(new Course[]{cs2420, cs3500, cs3810}, new CSNickname("John Doe [Supreme Overlord][2420, 3500, 3810]").getClasses().toArray());
    }
